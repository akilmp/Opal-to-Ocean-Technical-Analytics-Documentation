...
def test_transform_fact_day_matches_golden():
    commute = pd.read_csv("tests/transformations/data/commute.csv")
    environment = pd.read_csv("tests/transformations/data/environment.csv")
    personal = pd.read_csv("tests/transformations/data/personal.csv")
